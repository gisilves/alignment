...
int main(int argc, char **argv)
{
  if (argc < 4)
  {
    cout << "Usage: ./Alignment input_file #stations #iterations" << endl;
    exit(-1);
  }
  ...
  cout << "\n\n/////////////////// ALIGNMENT METHOD 1 ///////////////////\n\n";
  Alignment_1(myTree, correct_position, msd_stations);
  ...
  cout << "\n\n/////////////////// ALIGNMENT METHOD 2 ///////////////////\n\n";
  Alignment_2(myTree, correct_position, msd_stations);
  ...
  cout << "\n\n/////////////////// ALIGNMENT METHOD 3 ///////////////////\n\n";
  Alignment_3(myTree, correct_position, l_distances, msd_stations, atoi(argv[3]));
